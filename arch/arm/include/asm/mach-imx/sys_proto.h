...
#define IMX6_BMODE_USDHC_MASK		GENMASK(12, 11)
#define IMX6_BMODE_USDHC_SHIFT		11
#define IMX6_BMODE_SERIAL_ROM_MASK	GENMASK(26, 24)
#define IMX6_BMODE_SERIAL_ROM_SHIFT	24
#define IMX6_BMODE_SERIAL_ROM_CS_MASK	GENMASK(28, 29)
#define IMX6_BMODE_SERIAL_ROM_CS_SHIFT	28
