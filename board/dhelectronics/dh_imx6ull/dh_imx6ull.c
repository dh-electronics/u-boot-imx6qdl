...
static iomux_v3_cfg_t const gpio_pads[] = {
	MX6_PAD_SNVS_TAMPER0__GPIO5_IO00   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSOC_SWD-IO */
	MX6_PAD_SNVS_TAMPER1__GPIO5_IO01   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSOC_SWD-CLK */
	MX6_PAD_SNVS_TAMPER2__GPIO5_IO02   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSOC_Reset# */
	MX6_PAD_SNVS_TAMPER3__GPIO5_IO03   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Zigbee_PROG */
	MX6_PAD_SNVS_TAMPER4__GPIO5_IO04   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Zigbee_RESET# */
	MX6_PAD_SNVS_TAMPER6__GPIO5_IO06   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSoC: PWR_FAIL_OUT */
	MX6_PAD_SNVS_TAMPER7__GPIO5_IO07   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* NFC_Reset */
	MX6_PAD_SNVS_TAMPER8__GPIO5_IO08   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* NFC_IRQ */
	MX6_PAD_SNVS_TAMPER9__GPIO5_IO09   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* WL_REG_ON (WiFi on LGA) */

	MX6_PAD_UART1_CTS_B__GPIO1_IO18    | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* BT_REG_ON (BT on LGA) */
	MX6_PAD_GPIO1_IO05__GPIO1_IO05     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Button_User */
	MX6_PAD_GPIO1_IO08__GPIO1_IO08     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Button_Reset */
	MX6_PAD_CSI_PIXCLK__GPIO4_IO18     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Optional: GPIO_LED_G */
	MX6_PAD_CSI_DATA02__GPIO4_IO23     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Optional: GPIO_LED_B */
	MX6_PAD_CSI_DATA03__GPIO4_IO24     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Optional: GPIO_LED_R */
	MX6_PAD_ENET2_RX_DATA1__GPIO2_IO09 | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* GPIO_X10-9 */
	MX6_PAD_ENET1_TX_DATA1__GPIO2_IO04 | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* GPIO_X10-10 */
	MX6_PAD_ENET2_RX_DATA0__GPIO2_IO08 | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* GPIO_X10-11 */
	MX6_PAD_ENET1_TX_DATA0__GPIO2_IO03 | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* GPIO_X10-12 */
	MX6_PAD_ENET1_RX_DATA0__GPIO2_IO00 | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSoC: GPIO_reserve_1 */
	MX6_PAD_ENET1_TX_EN__GPIO2_IO05    | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSoC: GPIO_reserve_2 */
	MX6_PAD_ENET1_TX_CLK__GPIO2_IO06   | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* PSoC: GPIO_reserve_3 */

	MX6_PAD_LCD_DATA00__GPIO3_IO05     | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* Muxing all LCD data pins as GPIO */
	MX6_PAD_LCD_DATA01__GPIO3_IO06     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA02__GPIO3_IO07     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	...
	MX6_PAD_LCD_DATA06__GPIO3_IO11     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA07__GPIO3_IO12     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA08__GPIO3_IO13     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA09__GPIO3_IO14     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA10__GPIO3_IO15     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA11__GPIO3_IO16     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA12__GPIO3_IO17     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA13__GPIO3_IO18     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA14__GPIO3_IO19     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA15__GPIO3_IO20     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA16__GPIO3_IO21     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA17__GPIO3_IO22     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA18__GPIO3_IO23     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA19__GPIO3_IO24     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA20__GPIO3_IO25     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA21__GPIO3_IO26     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA22__GPIO3_IO27     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	MX6_PAD_LCD_DATA23__GPIO3_IO28     | MUX_PAD_CTRL(GPIO_PAD_CTRL),
};
