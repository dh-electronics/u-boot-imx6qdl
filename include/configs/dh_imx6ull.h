...
#define EXTRA_ENV_SETTINGS \
	...
	"linuxargs=setenv bootargs" \
		...
		" dhblloc=${dhblloc} dhenvloc=${dhenvloc} dhcor=${dhcor} dhsw=${dhsw} SN=${SN} PSN=${PSN}\0" \
	...
	"setupdateargs=setenv bootargs" \
		...
		" vt.global_cursor_default=0 consoleblank=0 ${backlight} dhblloc=${dhblloc} dhenvloc=${dhenvloc} dhcor=${dhcor} dhsw=${dhsw} SN=${SN} PSN=${PSN}\0" \
